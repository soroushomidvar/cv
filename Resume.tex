...
\photo[60pt][0.4pt]{6}                       % optional, remove / comment the line if not wanted; '64pt' is the height the 
...
\cvitem{}{+ Online Courses: Machine Learning (Coursera), Neural Networks and Deep Learning (Coursera),  \href{http://coursera.org/verify/H48HURQY897A}{Build Basic GANs (Coursera)}}
