...
\usepackage[scale=0.8,top=2cm,bottom=30mm]{geometry}
...
\cvitem{Social}{ \href{https://gitlab.com/soroush.mid}{\faGitlab \ soroush.mid}
						 \href{https://github.com/soroushomidvar}{\faGithub \ soroushomidvar}
						 \href{live:soroush.mid}{\faSkype \ soroush.mid}
...
\cventry{Fall 2015}{Digital System Design}{Project Supervisor}{Department of Computer Engineering}{}{Dr. Mariam Zomorodi Moghadam}
